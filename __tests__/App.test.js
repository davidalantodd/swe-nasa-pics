...
describe("App", () => {
  ...
  // integration test (involves interactions between components within the App, specifically between the date picker component and the component that displays the selected date.) -- could also be considered functional since it is testing interactions between the two primary components of the app
